...
const CHIEF_CAN_PROPOSE = [
  ...
  "- When Front is connected through Pipedream, inventory with search_front_conversations. Private tags resolve via Config front.teammate_id, an explicit teammate arg, or Front /me. Prefer tag_name for a tagged queue. Follow nextCursor until hasMore is false. Then PROPOSE Front MCP writes on Ask.",
  "",
