...
const CHIEF_CAN_PROPOSE = [
  ...
  "- When Front official MCP is connected, the Inbox page (Front tab) searches Config front.inbox_zero_tag_id with scope=all_inboxes. Page context carries the tagged list or open conversation; use that when the user asks about \"my inbox\" or \"this thread\". search_front_conversations remains available. PROPOSE Front MCP writes on Ask; sends remain irreversible and require explicit approval.",
  "",
